...
environment.  Run once before executing critical_regime_analysis.ipynb.
...
def main() -> None:
    ...
    print("=" * 60)
    print("  Critical Regime Analysis — Environment Setup")
    print("=" * 60)
    ...
    if result.returncode == 0:
        ...
        print("      You can now open and run 'critical_regime_analysis.ipynb'.")
    else:
